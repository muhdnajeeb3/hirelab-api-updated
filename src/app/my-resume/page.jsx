	...
	return(
		<>
			<div className="page-content">
				...
				<div className="overlay-black-dark profile-edit p-t50 p-b20" style={{backgroundImage:"url("+bnr.default.src+")"}}>
							...
							<div className="row">
								...
								<div className="col-xl-9 col-lg-8 col-md-8 col-sm-12">
									<div id="resume_headline_bx" className=" job-bx bg-white m-b30">
										<div className="d-flex">
											...
											<Link href='' className="site-button add-btn button-sm" onClick={()=>setResume(true)}>
									...
									<div id="key_skills_bx" className="job-bx bg-white m-b30">
										<div className="d-flex">
											...
											<Link href='' data-toggle="modal" data-target="#keyskills" onClick={()=>setKeyskill(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
										</div>
										<div className="job-time mr-auto">
											...
											<Link href='' className="mr-1"><span>Web Designing</span></Link>
											<Link href='' className="mr-1"><span>Photoshop</span></Link>
										</div>
									...
									<div id="employment_bx" className="job-bx bg-white m-b30 ">
										<div className="d-flex">
											...
											<Link href='' onClick={()=>setEmployment(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
										</div>
									...
									<div id="education_bx" className="job-bx bg-white m-b30">
										<div className="d-flex">
											...
											<Link href='' onClick={()=>setEducation(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
										</div>
									...
									<div id="it_skills_bx" className="job-bx table-job-bx bg-white m-b30">
										<div className="d-flex">
											...
											<Link href='' onClick={()=>setItSkills(true)} className="site-button add-btn button-sm">
												<i className="fa fa-pencil m-r5"></i> Edit
											</Link>
										</div>
										<p>Mention your employment details including your current and previous company work experience</p>
									...
									<div id="projects_bx" className="job-bx bg-white m-b30">
										<div className="d-flex">
											...
											<Link href='' onClick={()=>setProjects(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
										</div>
									...
									<div id="profile_summary_bx" className="job-bx bg-white m-b30" >
										<div className="d-flex">
											...
											<Link href='' onClick={()=>setProfileSummary(true)} className="site-button add-btn button-sm">
												<i className="fa fa-pencil m-r5"></i> Edit
											</Link>
										</div>
										...
										<div className="list-row">
											<div className="list-line">
												<div className="d-flex">
													...
													<Link href='' onClick={()=>setOnlineProfile(true)} className="site-button add-btn button-sm">
														<i className="fa fa-pencil m-r5"></i> Edit
													</Link>
												</div>
												<p className="m-b0">Add link href Online profiles (e.g. Linkedin, Facebook etc.).</p>
											...
											<div className="list-line">
												<div className="d-flex">
													...
													<Link href='' onClick={()=>setWorkSample(true)} className="site-button add-btn button-sm">
														<i className="fa fa-pencil m-r5"></i> Edit
													</Link>
												</div>
												<p className="m-b0">Add link href your Projects (e.g. Github links etc.).</p>
											...
											<div className="list-line">
												<div className="d-flex">
													...
													<Link href='' onClick={()=>setWhitePaper(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
												</div>
											...
											<div className="list-line">
												<div className="d-flex">
													...
													<Link href=''  onClick={()=>setPresentation(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
												</div>
											...
											<div className="list-line">
												<div className="d-flex">
													...
													<Link href='' data-toggle="modal" data-target="#patent" onClick={()=>setPatent(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
												</div>
											...
											<div className="list-line">
												<div className="d-flex">
													...
													<Link href='' onClick={()=>setCertification(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
												</div>
								...
								<div id="desired_career_profile_bx" className="job-bx bg-white m-b30">
									<div className="d-flex">
										...
										<Link href='' onClick={()=>setCareerProfile(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
									</div>
								...
								<div id="personal_details_bx" className="job-bx bg-white m-b30">
									<div className="d-flex">
										...
										<Link href=''  onClick={()=>setPersonalDetails(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
									</div>
