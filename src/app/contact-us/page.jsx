	...
	return(
		<>
			<div className="page-content bg-white">
				<div className="dez-bnr-inr overlay-black-middle" style={{ backgroundImage: `url(${bnr.src})` }}>
								...
								<div className="p-a30 border m-b30 contact-area border-1 align-self-stretch radius-sm">
									...
									<ul className="no-margin">
										<li className="icon-bx-wraper left m-b30">
											<div className="icon-bx-xs border-1"> <Link href={"#"} className="icon-cell"><i className="ti-location-pin"></i></Link> </div>
										...
										<li className="icon-bx-wraper left  m-b30">
											<div className="icon-bx-xs border-1"> <Link href={"#"} className="icon-cell"><i className="ti-email"></i></Link> </div>
											<div className="icon-content">
										...
										<li className="icon-bx-wraper left">
											<div className="icon-bx-xs border-1"> <Link href={"#"} className="icon-cell"><i className="ti-mobile"></i></Link> </div>
											<div className="icon-content">
									...
									<div className="m-t20">
										<ul className="dez-social-icon dez-social-icon-lg">
											<li><Link href={"#"} className="fa fa-facebook bg-primary mr-1"></Link></li>
											<li><Link href={"#"} className="fa fa-twitter bg-primary mr-1"></Link></li>
											<li><Link href={"#"} className="fa fa-linkedin bg-primary mr-1"></Link></li>
											<li><Link href={"#"} className="fa fa-instagram bg-primary mr-1"></Link></li>
											<li><Link href={"#"} className="fa fa-google-plus bg-primary"></Link></li>
										</ul>
									</div>
								</div>
							</div>
