								...
								<div className="col-lg-6 col-md-6 overlay-primary-dark d-flex p-a0" style={{backgroundImage: "url(" + bnr2 + ")",  backgroundPosition:"center", backgroundSize:"cover" }}>
									<div className="form-info text-white align-self-center">
										...
										<ul className="list-inline m-a0">
											<li><Link href={"#"} className="m-r10 text-white"><i className="fa fa-facebook"></i></Link></li>
											<li><Link href={"#"} className="m-r10 text-white"><i className="fa fa-google-plus"></i></Link></li>
											<li><Link href={"#"} className="m-r10 text-white"><i className="fa fa-linkedin"></i></Link></li>
											<li><Link href={"#"} className="m-r10 text-white"><i className="fa fa-instagram"></i></Link></li>
											<li><Link href={"#"} className="m-r10 text-white"><i className="fa fa-twitter"></i></Link></li>
										</ul>
									</div>
								</div>
