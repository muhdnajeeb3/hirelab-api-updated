	...
	return(
		<>
			...
			<div className="page-content">
				...
				<Jobsection />
				<div className="section-full p-tb70 overlay-black-dark text-white text-center bg-img-fix" style={{backgroundImage: "url(" + bnr9 + ")"}}>
					<div className="container">
						<div className="section-head text-center text-white">
							<h2 style={{fontWeight:'501'}} className="m-b5">Testimonials</h2>
