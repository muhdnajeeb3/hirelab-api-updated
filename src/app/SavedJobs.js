			...
			<div className="job-bx save-job browse-job table-job-bx clearfix">
				<div className="job-bx-title clearfix">
					...
					<div className="float-right">
						...
						<Link href={"#"} className="btn site-button" onClick={()=> setPostModal(true)}>+ Add Job</Link>
					</div>
				</div>
				<table>
					<thead>
					...
					<tbody>
						 {contacts.map((contact, index)=>(
							<tr key={index}>
								...
								<td className="job-name"><Link href={"/job-detail"}>{contact.title}</Link></td>
								<td className="criterias text-primary"><Link href={"/company-profile"}>{contact.company}</Link></td>
